...
**This skill gives generic advice by default. Fill in your details below and the audit will prioritize the areas that matter most for your setup.**
...
- **Current open rate**: [e.g., 20%]
- **Current bounce rate**: [e.g., 1.5%]
- **Current complaint rate**: [e.g., 0.06%]
