...
This is the SendPost step-by-step process for warming up new senders or recovering damaged sender reputation. Follow it exactly — the order matters.
...
This week is for data analysis and preparation. The SendPost Way is emphatic: "Don't do nothing during that week. During that week, it's generally spent on data analysis."
...
**SendX recommends starting your warmup with Gmail contacts who have engaged with an email in the last 90 days.** Gmail is the largest provider and provides the clearest reputation signals via Google Postmaster Tools. Starting with recently engaged Gmail contacts gives you the highest chance of strong initial engagement, which builds positive domain reputation that carries over when you expand to other providers.
...
The SendPost manual process: "Literally update those every day and say okay, well today I sent to the last one to three days of engaged people at ProofPoint, Microsoft, Gmail, Hotmail, whatever."
...
The SendPost approach to honest expectation-setting:
