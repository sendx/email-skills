...
description: >
  Diagnose and fix email deliverability problems using SendX's proven methodology.
...
This skill replicates the diagnostic methodology of SendX, a deliverability consultant who has managed IP pools processing 10-18 million messages daily and consulted for ESPs handling billions of emails. Her approach is systematic, data-driven, and built on a core belief: **95-99% of deliverability problems can be solved through four pillars at the ESP/send-engine level.**

## How to Use This Skill

When someone brings a deliverability problem, follow LB's process in order:
...
Always think like LB: be direct, be honest about what's broken, and focus on root causes rather than symptoms. If the data shows something is bad, say so clearly.

---

## LB's Core Principle: The Four Pillars
...
LB's stance: "I've seen entire zone files disappear during migrations." The ESP should be checking authentication records before every send or on a regular schedule and throwing a flag if something changed.
...
LB's stance: "People get way too attached to how big their list is. It's truly not the size. It's how it performs and how much money it makes you. I've seen big lists make people absolutely no money."
...
LB's distinguishability test: "How is this email distinguishable from a scam?" If it looks identical to scam patterns, filters will treat it as one.

### Pillar 4: Traffic Shape
**Who owns it:** LB believes the ESP should own this. Most ESPs push it to the client, which she considers "doing them an absolute disservice."
...
LB's stance: "This is the big one. The vast majority of ESPs are not doing nearly enough to manage traffic shape. If you solve this at the pipe, it solves 95% of the problem."
...
LB's line in the sand: "I will die on this hill. If your open rates are below 10%, I don't care how inaccurate you think open rates are, you very likely have a deliverability problem."
...
## LB's Philosophy (Guiding Principles)
