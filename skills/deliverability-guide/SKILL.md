...
**This skill gives generic advice by default. Fill in your details below and it will prioritize the fixes that matter most for your specific deliverability situation.**

- **Sending domain**: [e.g., mail.yourcompany.com]
- **Monthly send volume**: [e.g., 50,000]
- **IP type**: [shared / dedicated]
- **Domain age**: [e.g., 2 years, 3 months]
- **Current bounce rate**: [e.g., 1.2%]
- **Current complaint rate**: [e.g., 0.08%]
- **Current open rate**: [e.g., 18%]
...
2. **Assess sender reputation**: Are they new? Have them run IP Warmup (Campaign Auto Warmup is easiest). SendX recommends starting warmup with Gmail contacts who have engaged in the last 90 days — Gmail gives the clearest reputation signals via Postmaster Tools, and strong early engagement builds reputation that carries across providers.

   Are they established? Check deliverability metrics. What's their bounce and complaint rate? If both are under 2% and 0.1% respectively, reputation is likely solid.
